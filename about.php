		...
		<div class="row align-items-center">
			...
			<div class="col-md-5 ml-auto">
              ...
              <h2 class="mb-5">Deskripsi</h2>
				...
				<p class="mb-4">Terletak di kompleks Galuh Mas di jantung Kota Karawang, hotel Mercure Karawang bisa dicapai dengan berjalan kaki ke Karawang Central Plaza. Hotel ini juga hanya 10 menit naik mobil ke kawasan industri dan 5 menit ke balai kota Karawang.

Karawang terletak sekitar 60 km di timur Jakarta, merupakan area industri utama baru dengan berbagai properti industri internasional berskala besar dan beragam industri berat. Kota ini merupakan tempat bermarkasnya banyak raksasa industri Jepang.</p>
			</div>
		</div>
	</div>
</div>
